  ...
  override def answers(userAnswers: UserAnswers, name: String, index: Int, draftId: String)(implicit
    ...
    Seq(
      ...
      bound.yesNoQuestion(
        ...
        "individualProtector.dateOfBirthYesNo",
        DateOfBirthYesNoController.onPageLoad(index, draftId).url
      ),
      bound.dateQuestion(
        DateOfBirthPage(index),
        "individualProtector.dateOfBirth",
        DateOfBirthController.onPageLoad(index, draftId).url
      ),
      bound.yesNoQuestion(
        NationalityYesNoPage(index),
        "individualProtector.5mld.nationalityYesNo",
        NationalityYesNoController.onPageLoad(index, draftId).url
      ),
      bound.yesNoQuestion(
        NationalityUkYesNoPage(index),
        "individualProtector.5mld.nationalityUkYesNo",
        NationalityUkYesNoController.onPageLoad(index, draftId).url
      ),
      bound.countryQuestion(
        NationalityUkYesNoPage(index),
        NationalityPage(index),
        "individualProtector.5mld.nationality",
        NationalityController.onPageLoad(index, draftId).url
      ),
      bound.yesNoQuestion(
        NationalInsuranceYesNoPage(index),
        "individualProtector.nationalInsuranceYesNo",
        NationalInsuranceYesNoController.onPageLoad(index, draftId).url
      ),
      bound.ninoQuestion(
        NationalInsuranceNumberPage(index),
        "individualProtector.nationalInsuranceNumber",
        NationalInsuranceNumberController.onPageLoad(index, draftId).url
      ),
      bound.yesNoQuestion(
        CountryOfResidenceYesNoPage(index),
        "individualProtector.5mld.countryOfResidenceYesNo",
        CountryOfResidenceYesNoController.onPageLoad(index, draftId).url
      ),
      bound.yesNoQuestion(
        CountryOfResidenceInTheUkYesNoPage(index),
        "individualProtector.5mld.countryOfResidenceInTheUkYesNo",
        CountryOfResidenceInTheUkYesNoController.onPageLoad(index, draftId).url
      ),
      bound.countryQuestion(
        CountryOfResidenceInTheUkYesNoPage(index),
        CountryOfResidencePage(index),
        "individualProtector.5mld.countryOfResidence",
        CountryOfResidenceController.onPageLoad(index, draftId).url
      ),
      bound.yesNoQuestion(
        AddressYesNoPage(index),
        "individualProtector.addressYesNo",
        AddressYesNoController.onPageLoad(index, draftId).url
      ),
      bound.yesNoQuestion(
        AddressUkYesNoPage(index),
        "individualProtector.addressUkYesNo",
