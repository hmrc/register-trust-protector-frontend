...
import pages.register.individual.{AddressUkYesNoPage, NamePage}
...
class AddressUkYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  private val index = 0
  private val form: Form[Boolean] = new YesNoFormProvider().withPrefix("individualProtector.addressUkYesNo")
