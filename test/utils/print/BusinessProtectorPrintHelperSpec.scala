      ...
      "name and UTR" in {
        ...
        result mustBe AnswerSection(
          ...
          rows = Seq(
            ...
            AnswerRow("businessProtector.utrYesNo.checkYourAnswersLabel", Html("Yes"),
      ...
      "name, UTR and UK residency" in {
        ...
        result mustBe AnswerSection(
          ...
          rows = Seq(
            ...
            AnswerRow("businessProtector.5mld.countryOfResidenceYesNo.checkYourAnswersLabel", Html("Yes"),
              changeUrl = Some(controllers.register.business.mld5.routes.CountryOfResidenceYesNoController.onPageLoad(index, draftId).url),
              labelArg = name
            ),
            AnswerRow("businessProtector.5mld.countryOfResidenceInTheUkYesNo.checkYourAnswersLabel", Html("Yes"),
      ...
      "name, UTR and Non-UK residency" in {
        ...
        result mustBe AnswerSection(
          ...
          rows = Seq(
            ...
            AnswerRow("businessProtector.5mld.countryOfResidenceInTheUkYesNo.checkYourAnswersLabel", Html("No"),
              changeUrl = Some(controllers.register.business.mld5.routes.CountryOfResidenceInTheUkYesNoController.onPageLoad(index, draftId).url),
              labelArg = name
            ),
            AnswerRow("businessProtector.5mld.countryOfResidence.checkYourAnswersLabel", Html("France"),
      ...
      "name, Non-UK residency, UK address" in {
        ...
        result mustBe AnswerSection(
          ...
          rows = Seq(
            ...
            AnswerRow("businessProtector.addressYesNo.checkYourAnswersLabel", Html("Yes"),
              changeUrl = Some(controllers.register.business.routes.AddressYesNoController.onPageLoad(index, draftId).url),
              labelArg = name
            ),
            AnswerRow("businessProtector.addressUkYesNo.checkYourAnswersLabel", Html("Yes"),
              changeUrl = Some(controllers.register.business.routes.AddressUkYesNoController.onPageLoad(index, draftId).url),
              labelArg = name
            ),
            AnswerRow("site.address.uk.checkYourAnswersLabel", Html("Line 1<br />Line 2<br />NE981ZZ"),
      ...
      "name, Non-UK residency, Non-UK address" in {
        ...
        result mustBe AnswerSection(
          ...
          rows = Seq(
            ...
            AnswerRow("businessProtector.addressUkYesNo.checkYourAnswersLabel", Html("No"),
              changeUrl = Some(controllers.register.business.routes.AddressUkYesNoController.onPageLoad(index, draftId).url),
              labelArg = name
            ),
            AnswerRow("site.address.international.checkYourAnswersLabel", Html("Line 1<br />Line 2<br />France"),
      ...
      "name, Non-UK residency, No address" in {
        ...
        result mustBe AnswerSection(
          ...
          rows = Seq(
            ...
            AnswerRow("businessProtector.addressYesNo.checkYourAnswersLabel", Html("No"),
              changeUrl = Some(controllers.register.business.routes.AddressYesNoController.onPageLoad(index, draftId).url),
              labelArg = name
            )
          ),
