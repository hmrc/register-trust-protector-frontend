  ...
  "Individual protector print helper" when {
    ...
    "trustee has mentalCapacity No" in {
      val userAnswers: UserAnswers = emptyUserAnswers
        ...
        .success
        .value
        .set(LegallyCapableYesNoPage(index), YesNoDontKnow.No)
        .success
        .value
      ...
      result mustBe AnswerSection(
        ...
        Seq(
          AnswerRow(
            "individualProtector.name.checkYourAnswersLabel",
            Html(name.displayFullName),
            Some(NameController.onPageLoad(index, fakeDraftId).url),
            "",
            canEdit
          ),
          AnswerRow(
            "individualProtector.5mld.legallyCapableYesNo.checkYourAnswersLabel",
            Html("No"),
            Some(LegallyCapableYesNoController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          )
        )
    ...
    "trustee has mentalCapacity Don't know" in {
      val userAnswers: UserAnswers = emptyUserAnswers
        ...
        .success
        .value
        .set(LegallyCapableYesNoPage(index), YesNoDontKnow.DontKnow)
        .success
        .value
    ...
    "return an individual protector answer section" in {
      ...
      val userAnswers = emptyUserAnswers
        ...
        .success
        .value
        .set(DateOfBirthPage(index), date)
        .success
        .value
        .set(NationalityYesNoPage(index), true)
        .success
        .value
        .set(NationalityUkYesNoPage(index), false)
        .success
        .value
        .set(NationalityPage(index), country)
        .success
        .value
        .set(NationalInsuranceYesNoPage(index), true)
        .success
        .value
        .set(NationalInsuranceNumberPage(index), nino)
        .success
        .value
        ...
        .success
        .value
        .set(PassportDetailsPage(index), passportOrIdCard)
        .success
        .value
        .set(IDCardDetailsYesNoPage(index), true)
        .success
        .value
        .set(IDCardDetailsPage(index), passportOrIdCard)
        .success
        .value
      ...
      result mustEqual AnswerSection(
        ...
        rows = Seq(
          ...
          AnswerRow(
            "individualProtector.dateOfBirthYesNo.checkYourAnswersLabel",
            Html("Yes"),
            Some(DateOfBirthYesNoController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          ),
          AnswerRow(
            "individualProtector.dateOfBirth.checkYourAnswersLabel",
            Html("3 February 1996"),
            Some(DateOfBirthController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          ),
          AnswerRow(
            "individualProtector.5mld.nationalityYesNo.checkYourAnswersLabel",
            Html("Yes"),
            Some(NationalityYesNoController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          ),
          AnswerRow(
            "individualProtector.5mld.nationalityUkYesNo.checkYourAnswersLabel",
            Html("No"),
            Some(NationalityUkYesNoController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          ),
          AnswerRow(
            "individualProtector.5mld.nationality.checkYourAnswersLabel",
            Html("France"),
            Some(NationalityController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          ),
          AnswerRow(
            "individualProtector.nationalInsuranceYesNo.checkYourAnswersLabel",
            Html("Yes"),
            Some(NationalInsuranceYesNoController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          ),
          AnswerRow(
            "individualProtector.nationalInsuranceNumber.checkYourAnswersLabel",
            Html("AA 00 00 00 A"),
            Some(NationalInsuranceNumberController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          ),
          AnswerRow(
            "individualProtector.5mld.countryOfResidenceYesNo.checkYourAnswersLabel",
            Html("Yes"),
          ...
          AnswerRow(
            "individualProtector.5mld.countryOfResidenceInTheUkYesNo.checkYourAnswersLabel",
            Html("No"),
          ...
          AnswerRow(
            "individualProtector.5mld.countryOfResidence.checkYourAnswersLabel",
            Html("France"),
          ...
          AnswerRow(
            "individualProtector.addressYesNo.checkYourAnswersLabel",
            Html("Yes"),
          ...
          AnswerRow(
            "individualProtector.addressUkYesNo.checkYourAnswersLabel",
            Html("Yes"),
          ...
          AnswerRow(
            "individualProtector.passportDetailsYesNo.checkYourAnswersLabel",
            Html("Yes"),
            Some(PassportDetailsYesNoController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          ),
          AnswerRow(
            "individualProtector.passportDetails.checkYourAnswersLabel",
            Html("France<br />12345<br />3 February 1996"),
            Some(PassportDetailsController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          ),
          AnswerRow(
            "individualProtector.idCardDetailsYesNo.checkYourAnswersLabel",
            Html("Yes"),
            Some(IDCardDetailsYesNoController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          ),
          AnswerRow(
            "individualProtector.idCardDetails.checkYourAnswersLabel",
            Html("France<br />12345<br />3 February 1996"),
            Some(IDCardDetailsController.onPageLoad(index, fakeDraftId).url),
            arg,
            canEdit
          ),
          AnswerRow(
